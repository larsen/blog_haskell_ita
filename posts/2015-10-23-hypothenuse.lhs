...
Tutto inizio\` in chat #haskell.it (a cui siete invitati tutti). f-a chiede aiuto a meditans (in qualita\` di matematico del gruppo) su un esercizio.
...
L'esercizio e\` tratto da [Progamming Praxis](http://programmingpraxis.com/2015/10/09/searching-for-hypotenuses/)
